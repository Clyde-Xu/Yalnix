...
#define KERNEL_STACK_PNUM	(KERNEL_STACK_MAXSIZE / PAGESIZE)
#define KERNEL_STACK_BASE \
	DOWN_TO_PAGE(KERNEL_STACK_LIMIT - KERNEL_STACK_MAXSIZE)

#define KERNEL_STACK_BASEPAGE	(KERNEL_STACK_BASE >> PAGESHIFT)
#define KERNEL_STACK_LIMITPAGE	(KERNEL_STACK_LIMIT >> PAGESHIFT)
#define USER_STACK_LIMIT	VMEM_1_LIMIT
